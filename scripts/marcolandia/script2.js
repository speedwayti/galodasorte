...
baseImage.src = "../../img/marcolandia/resultado4.jpg";
...
$( "#btnSubmit" ).click(function() {
  ...
  context.fillText(n1, 285, 825);
  context.fillText(n2, 425, 825);
  context.fillText(n3, 565, 825);
  context.fillText(n4, 705, 825);
