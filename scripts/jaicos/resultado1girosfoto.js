...
baseImage.src = city+"/resultado1girosfoto.png";
...
async function preencheInformacoes(){
 ...
 // const box2 = $("#box2").val();
  ...
  context.fillText(box1, 570, 955);
  //context.fillText(box2, 570, 1215);
  //context.fillText(box3, 570, 1370);

  context.font = "160px arial";
  context.fillText(n1, 560, 1080);
  //context.fillText(n2, 560, 1340);
 
  //context.fillText(n3, 560, 1470);
