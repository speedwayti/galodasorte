...
baseImage.src = city+"/resultado12girosfoto.png";
...
async function preencheInformacoes(){
  ...
  context.fillText(n0, 275, 1025);
  context.fillText(n1, 800, 1025);
  ...
  context.fillText(box0, 275, 930);
  context.fillText(box1, 795, 930);
